...
public class finepayment
{
    ...
    enum type{UG,UNDERGRADUATE,POSTGRADUATE,PG,SCHOLARS,STAFF};

    int a;String post=new String();
    System.out.print("Enter number of borrowed days:");a=sc.nextInt();sc.nextLine();
    System.out.print("Enter position:");post=sc.nextLine();
...
class ug extends library
{
    ...
    void display(){calc();System.out.println("UG student:");super.display();}
    int calc()
    {
...
class pg extends library
{
    ...
    void display(){calc();System.out.println("PG student:");super.display();}
    int calc()
    {
...
class staff extends library
{
    ...
    void display(){calc();System.out.println("STAFF:");super.display();}
    int calc()
    {
